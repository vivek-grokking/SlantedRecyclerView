...
public abstract class BaseCustomImageView extends ImageView {

    public BaseCustomImageView(Context ctx, AttributeSet attrs) {
        super(ctx, attrs);
    }
    ...
    protected abstract Path getPath(int w, int h);
